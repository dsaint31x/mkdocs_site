...
* 이는 좀더 개발자가 사용하기 쉽다는 뜻이며, 반대로는 HW 보다 사람에 친화적인 언어라고 볼 수 있음.
...
> 참고:  
> SW개발에서 필요한 IDE (Integrated Development Environment)들이 상당수 무료 또는 저렴하게 사용할 수 있는 것과 비교하면, FPGA에서의 IDE에 해당하는 EDA (Electronic Design Automation)의 접근성이 과거에는 좀 더 낮았다. 하지만 2024년 2월에 발표된 Rapid Silicon의 Raptor Design Suite는 업계 최초의 완전한 오픈소스 FPGA SDK 및 컴파일러를 개발자들에게 무료로 제공하는 등의 FPGA 설계의 진입 장벽을 낮추는 시도들이 이루어지고 있음.
