---
title: Console, Terminal, and Shell
tags: [ console, tty, terminal, shell, bash, zsh, kernel, os, cli, builtin ]
---
...
>
> 과거 terminal이나 console 모두 teletype(`tty`, 독립된 H/W system)로 구성되었으나, 기술의 발전으로 
> 
> * 다른 컴퓨터의 OS에 접속하거나 
...
> * 프로그램 실행한 결과를 표준 출력으로 받아 terminal을 통해 사용자에게 표시
>  
...
Korn Shell (`ksh`) 과 C Shell (`csh`)도 있으나 `bash`나 `zsh`에 비해 현재 사용도가 떨어지는 편임.

---

## 더 읽어보면 좋은 자료들.

* `tty`의 용어 유래 등의 역사를 살펴보려면 다음 URL을 참고하라: [Keyboard와 Terminal의 역사](https://dsaint31.me/mkdocs_site/CE/ch06/ce06_4_04_keyboard/#keyboard)
...
* [간단 Linux CLI 명령어 소개](./linux_cmds.md)
* [간단 Windows CLI 명령어(`cmd.exe`) 소개](./windows_cmds.md)
* [간단 Windows PowerShell 명령어(`powershell.exe`) 소개](https://ds31x.tistory.com/579)