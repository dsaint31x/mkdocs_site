...
![](../img/ch00/semisupervised_learning.png){style="display: block; margin: 0 auto;width:400px"}
...
* DBN을 학습시킨 방식을 `Greedy Layer-wise Learning`이라고도 부름.

> 참고로,
> `Greedy Layer-wise Learning`은
> 오늘날 end-to-end learning이 주류로 자리잡으면서 많이 사용되고 있진 않음.
