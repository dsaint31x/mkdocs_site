---
title: Solutions for the Gradient Vanishing or Exploding Problem
categories:
  - Deep Learning
  - Neural Network
tags:
...
* forward-flow (or forward pass)와 backward-flow (or backward pass) 두 단계로 수행되고,
* backward-flow에서는 loss function의 partial derivatives (=error gradient)가 output에서 input으로 전달되게 되는데,
