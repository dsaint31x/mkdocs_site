...
![](./img/mc_culloch_n_pitts.png){style="display: block; margin: 0 auto; width: 500px"}
...
* [범용적인 컴퓨팅 장치(=switch 더 정확히는 logic gate로 구현가능, Claude Shannon 1937)](https://ds31x.tistory.com/393)를 만들 수 있다는 얘기임.
...
![](./img/Mcculloch_Pitts_artificial_neuron.png){style="display: block; margin: 0 auto; width: 500px"}
...
![](./img/single_layer_perceptron.png){style="display: block; margin: 0 auto; width: 500px"}
...
> Feedforward ANN의 경우, 이론상으로는 충분한 조건에서 임의의 continuous function을 원하는 정확도로 approximation 할 수 있음이 증명됨: [Universal Approximation Theorem (UAT)](https://ds31x.blogspot.com/2023/08/dl-universal-approximation-theorem-uat.html?view=classic)

---

## Perceptron의 한계

![](./img/minsky.png){style="display: block; margin: 0 auto; width: 500px"}
...
> 안타깝게도 Rosenblatt은 perceptron의 한계를 극복하지 못했고 1971년 의문의 보트사고로 43세의 생을 마감했다.
> 아이러니한 건 Minsky와 Rosenblatt이 고교 동창이라는 점이다.
> 최초의 ANN의 유행을 만든 사람과 그 유행을 끝장낸 사람이 한 고등학교에서 나온 셈.

![](./img/and_or_xor_perceptron.png){style="display: block; margin: 0 auto; width: 500px"}
...
[Learning representations by back-propagating errors (Rumelhart, Hinton, Williams)](https://www.nature.com/articles/323533a0))
